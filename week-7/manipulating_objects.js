...
// What tests did you have trouble passing? What did you do to make it pass? Why did that work?  The tests  I had trouble passing were creating the individual children within the children property. I did some research and was able to see how I could access and create a new item within a particular hash. It worked because I was able to call the original hash, the children hash within that, and then create a new key/value pair.
//
//How difficult was it to add and delete properties outside of the object itself?  I did not have too much difficulty adding and deleting properties outside of the object. We practiced this in Ruby so I was familiar with the process but just had to do some research on the syntax.
//
//What did you learn about manipulating objects in this challenge?  I learned that if you are accessing inner objects (in this case inner hashes) within a larger object, you must call each item from the outermost in and then create a new key/value pair.
//
